...
export const initialState = {
  ...
  // Shared cross-page ecosystem state (Dashboard ↔ Job Hub ↔ Team ↔ Analytics ↔ Bell)
  activeDashboardRole: 'freelancer',
  ...
  latestJobs: [],
  nextWeekJobs: [],
  earningsByRole: { freelancer: 0, photographer: 0 },
  unreadCount: 0,
  analyticsRole: 'photographer',
